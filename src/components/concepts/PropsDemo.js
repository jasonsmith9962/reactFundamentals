        ...
        <div className="main">
            <div className="mainDiv">
                <div style={styles}>
                    ...
                    <FunctionalComponent string="Component call #1" function={toggleBackgroundColor} selectedStyle={ backgroundColor } />
                    <FunctionalComponent string="Component call #2" function={toggleBorderRadius} selectedStyle={ borderRadius } />
                    <FunctionalComponent string="Component call #3" function={toggleBorderStyle} selectedStyle={ borderStyle } />
                </div>
            </div>
        </div>
    );
