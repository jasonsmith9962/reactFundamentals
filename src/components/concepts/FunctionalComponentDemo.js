        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <dl>
                    ...
                    <dd>By passing props, Functional Components are capable of both rendering state variables for display, as well as updating the value of state variable(s). We will take a deeper dive into state and props later on - so do not fret if that doesn't make sense right now.</dd>
